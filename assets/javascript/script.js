$(function () {
    $('#mail').blur(function () {
        ...
        $.post('../controllers/controller-register-user.php', {mailTest: $(this).val()}, function (data) {
            ...
            if(data == 0){
                ...
                $('.mailMessage').html('<p class="text-success">L\'adresse mail est est disponible</p>');
            }else{
                $('.mailMessage').html('<p class="text-danger">L\'adresse mail est déjà utilisé</p>');
            }
        });
    });
});
